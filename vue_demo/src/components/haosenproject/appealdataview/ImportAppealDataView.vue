  ...
  <div class="appeal-management-view">
    ...
    <div class="upload-container">
      <div class="upload-card">
        <h1 class="upload-title">上传申诉数据</h1>
...
const resultKey = ref(0) // 用于强制 el-result 重新创建
