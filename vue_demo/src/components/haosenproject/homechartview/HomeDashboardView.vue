...
// 导入四个图表组件（路径根据你的项目调整）
import BarChart from '@/components/haosenproject/homechartview/CleanBarChart.vue'
import PieChart from '@/components/haosenproject/homechartview/MainDataPieChart.vue'
import RosePieChart from '@/components/haosenproject/homechartview/BranchBarChart.vue'
import LineChart from '@/components/haosenproject/homechartview/AppealUpdateChart.vue'
