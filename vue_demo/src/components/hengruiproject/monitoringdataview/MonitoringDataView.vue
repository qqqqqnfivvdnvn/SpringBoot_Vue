        ...
        <div class="content-wrapper" v-loading="loading">
          ...
          <div v-if="viewMode === 'table'" class="table-view">
            ...
            >
              ...
              <el-table-column prop="onlineStorePrice" label="网店价格" width="80" />
              <el-table-column prop="boxQuantity" label="盒数" width="70" />
              <el-table-column prop="unitPricePerBox" label="单盒价" width="70" />
              <el-table-column prop="storeName" label="店铺名称" width="150" show-overflow-tooltip />
              <el-table-column prop="businessLicenseName" label="营业执照名称" width="150" show-overflow-tooltip />
              <el-table-column prop="province" label="省" width="75" />
              <el-table-column prop="city" label="市" width="75" />
              <el-table-column prop="salesVolume" label="销量" width="80" show-overflow-tooltip />
              <el-table-column prop="keyId" label="KeyID" width="100" show-overflow-tooltip />
              <el-table-column prop="name" label="标准名称" width="120" show-overflow-tooltip />
