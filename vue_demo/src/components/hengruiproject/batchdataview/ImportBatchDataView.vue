...
const submitFile = async () => {
  ...
  try {
    ...
    const {data} = await axios.post('/api/hengrui/batch/uploadFile', formData, {
...
.custom-upload :deep(.el-upload-dragger.is-dragover) {
  ...
  background-color: rgba(255, 125, 109, 0.05);
}

html.dark .custom-upload :deep(.el-upload-dragger.is-dragover) {
  background-color: rgba(255, 125, 109, 0.1);
}
