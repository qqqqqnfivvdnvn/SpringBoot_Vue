<template>
  <div class="relation-import-view" :style="themeStyle">
    <!-- 文件上传区域 -->
    <div class="upload-container">
      <div class="upload-card">
        <div class="upload-title">上传比对关系文件</div>
        ...
        <div class="template-section">
          ...
          <el-descriptions :column="1" border size="small">
            ...
            <el-descriptions-item label="处理说明">
              只导入营业执照名称和 keyid 不存在的记录，重复的记录将自动跳过
            </el-descriptions-item>
          </el-descriptions>
        </div>
      </div>
...
function loadThemeColor() {
  const savedColor = sessionStorage.getItem('themeColor_HengRuiHome')
  if (savedColor) {
...
.custom-upload :deep(.el-upload-dragger) {
  border: 1px dashed var(--theme-primary, #6ab7ff);
  border-radius: 3px;
  padding: 20px 12px;
  text-align: center;
  cursor: pointer;
