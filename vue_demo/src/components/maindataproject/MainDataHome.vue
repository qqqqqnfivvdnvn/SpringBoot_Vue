...
html.dark .navbar {
  background: linear-gradient(90deg, #1a3a5f 0%, #295080 60%, #3a6090 100%);
...
html.dark .menu-label {
  color: var(--theme-text-dark, #6bb3ff);
}
...
.menu-item:hover {
  background: linear-gradient(135deg, #e8f4ff, #dbe8f8);
  color: var(--theme-primary);
}

html.dark .menu-item:hover {
  background: linear-gradient(135deg, #1a3a5f, #1a2f4a);
  color: var(--theme-text-dark, #6bb3ff);
}

.menu-open > .menu-item {
  background: linear-gradient(135deg, #e5f4ff, #d0e8f8);
  color: var(--theme-primary);
}

html.dark .menu-open > .menu-item {
  background: linear-gradient(135deg, #1a4060, #1a3550);
  color: var(--theme-text-dark, #6bb3ff);
}
...
html.dark .sub-icon {
  color: var(--theme-icon-dark, #6bb3ff);
}
...
html.dark .toast {
  background: linear-gradient(135deg, #2980d9, #1a5a8a);
